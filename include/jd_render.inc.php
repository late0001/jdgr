...
$sysedition = '4.2.8';
$authkey = 'mamalaile';
$itemfields = array('title','shorttitle','aimurl','filename','category','section','template','price','author','source','dateline','pageview','picture','attach','comment','keywords','tags','digest','data','paging','orderby','orderby2','orderby3','orderby4','orderby5','orderby6','orderby7','orderby8');
$IIIIIIIIIIII = JD_ROOT.'configs/auth.php';
$IIIIIIIIIIIl = JD_ROOT.'configs/auth.lst';
$authsuccess = 0;
if($__callmode == 'web') $_vc = jd_md5($_SERVER['HTTP_USER_AGENT']."\t".$_SERVER['REMOTE_ADDR'],1);
if(file_exists($IIIIIIIIIIII)) {
        ...
        if(strpos($IIIIIIIIIII1,'#') !== false) {
            ...
            if($IIIIIIIIII1I <$IIIIIIIIII1l) {
                ...
                $authsuccess = 1;
                    ...
                    if(!empty($_SERVER['SERVER_ADDR']) &&$IIIIIIIIIIll == $_SERVER['SERVER_ADDR'])
                        $authsuccess = 1;
                    if($IIIIIIIIIIll == $_SERVER['HTTP_HOST'])
                        $authsuccess = 1;
                    if(strlen($_SERVER['HTTP_HOST']) >strlen($IIIIIIIIIIll) &&substr($_SERVER['HTTP_HOST'],strlen($IIIIIIIIIIll) * -1) == $IIIIIIIIIIll) 
                        $authsuccess = 1;
                }
            }
        }else {
            ...
            foreach($IIIIIIIIIlII as $IIIIIIIIIII1) {
                ...
                if(strlen($_SERVER['HTTP_HOST']) >strlen($IIIIIIIIIII1) &&substr($_SERVER['HTTP_HOST'],strlen($IIIIIIIIIII1) * -1) == $IIIIIIIIIII1) 
                    $authsuccess = 1;
    ...
    if($IIIIIIIIIII1 == ''&&empty($IIIIIIIIIlI1)) {
        ...
        $IIIIIIIIIl1I = 'http://auth.akcms.com/getauth.php?version='.$sysedition.'&key='.$IIIIIIIIIlll;
...
function decodeauth($IIIIIIIII1II) {
    ...
    $IIIIIIIII1II = jd_xor($IIIIIIIII1II,$GLOBALS['authkey']);
...
function renderdata($IIIIIIIII1l1,$IIIIIIIII11I) {
    ...
    foreach($IIIIIIIII1l1 as $IIIIIIIIllIl =>$IIIIIIIIllI1) {
        ...
        foreach($IIIIIIIIlIll as $IIIIIIIIlI1I) {
            ...
            if(!empty($IIIIIIIIll1l)) {
                ...
                if(a_is_int($IIIIIIIIll1l)) {
                    ...
                    $IIIIIIIIllI1["$IIIIIIIIlI1I:$IIIIIIIIll1l"] = jd_substr($IIIIIIIIll11,0,$IIIIIIIIll1l);
                }
        ...
        $IIIIIIIII11l .= jd_array_replace($IIIIIIIII111,$IIIIIIIIllI1,$IIIIIIIIlllI);
        $IIIIIIIIlI1l ++;
...
function renderhtml($IIIIIIIIl1Il,$IIIIIIIIl1I1) {
    ...
    $IIIIIIIIl1Il = jd_replace('[inc]',$IIIIIIII1III,$IIIIIIIIl1Il);
    $IIIIIIII1IIl = '';
    if(empty($authsuccess)) $IIIIIIII1IIl = "<!--jdcms--><span id='poweredjdcms'>Powered by <a href='http://www.akcms.com' target='_blank'>JDCMS</a></span><script type='text/javascript'>if(isVisible(document.getElementById('poweredjdcms'))== false) {var html_doc = document.getElementsByTagName('head')[0];var s = document.createElement(\"script\");s.src = \"http://s.akcms.com/p.js?r=".random(6)."\";html_doc.appendChild(s);} function isVisible(obj){try{obj.focus();}catch(e){return false;}return true;}</script>";
    $IIIIIIIIl1Il = jd_replace('[*home*]',$homepage,$IIIIIIIIl1Il);
    $IIIIIIIIl1Il = jd_replace('[powered]',$IIIIIIII1IIl,$IIIIIIIIl1Il);
    $IIIIIIIIl1Il = jd_replace('[n]',"\n",$IIIIIIIIl1Il);
...
function getcopyrightinfo() {
    return "<center class='mininum' style='margin-top:5px;'><a href='http://www.akcms.com/' target='_blank'>Copyright &copy; 2007-2012 {$GLOBALS['sysname']}&nbsp;{$GLOBALS['sysedition']}</a></center>";
}
